...
但条件判断 `res.data.data` 导致进入错误分支，显示"AI响应数据异常"。
...
## 2025-10-25 - 前端ElTag组件type属性验证错误修复
