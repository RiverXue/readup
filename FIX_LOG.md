...
## 2025-09-27 总体README全面重构与项目架构展示
...
### 2025-09-12 - 用户管理界面初始化时状态变更事件误触发修复
...
### 2025-09-12 - ArticleReader句子解析弹窗样式缺失修复
...
## 2025-09-27 - 前端ElTag组件type属性验证错误修复
