...
- **AI服务**：12个接口（DeepSeek智能分析、腾讯云翻译、AI助手、读后测验持久化、Rayda老师学习导师）
- **文章服务**：7个接口（文章发现、阅读管理、内容提取）
- **用户服务**：18个接口（用户认证、三级词库、订阅管理）
- **报告服务**：9个接口（学习统计、艾宾浩斯复习、数据仪表盘、用户画像分析）
- **管理员服务**：25个接口（系统配置管理、后台管理、数据统计）

> **📝 更新说明**：经过AI API清理优化，删除了10个冗余接口，保留核心功能，提升系统性能和维护性。新增Rayda老师学习导师和用户画像分析功能。
